...
public final class WcWidth {
    ...
    private static final int[][] ZERO_WIDTH = { { 0x0300, 0x036f }, // Combining Grave Accent ..Combining Latin Small Le
    ...
    private static final int[][] WIDE_EASTASIAN = { { 0x1100, 0x115f }, // Hangul Choseong Kiyeok ..Hangul Choseong
