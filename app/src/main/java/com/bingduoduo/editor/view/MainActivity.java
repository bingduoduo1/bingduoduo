...
public class MainActivity extends BaseDrawerLayoutActivity {
    ...
    private void setDefaultFragment(@IdRes int fragmentId) {
        baseFragment = new FolderManagerFragment();
        getSupportFragmentManager().beginTransaction().replace(fragmentId, baseFragment).commit();
    }
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    getDelegate().setLocalNightMode(
                            currentNightMode == Configuration.UI_MODE_NIGHT_NO ? AppCompatDelegate.MODE_NIGHT_YES
